...
class QuoteSchema(Schema):
    ...
    content = fields.Str(require=True, validate=must_not_be_blank)
...
def get_quote(pk):
    ...
    result = quotes_schema.dump(quote)
    return {"quote": result}
...
def new_quote():
    ...
    # Create new quote
    quote = Quote(content=data["content"], author=author, posted_at=datetime.datetime.utcnow())
